...
def load_ResNet101Model():
    ...
    copy_parameter_from_resnet(model, models.resnet101(weights=models.ResNet101_Weights.IMAGENET1K_V1.DEFAULT).state_dict())
    return model

def load_ResNet152Model():
    model = ResNet(Bottleneck, [3, 8, 36, 3])
    copy_parameter_from_resnet(model, models.resnet152(weights=models.ResNet152_Weights.IMAGENET1K_V1.DEFAULT).state_dict())
    return model
